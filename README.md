...
* sample-assembly - an assembly that talks to the sample HCD
* sample-hcd - an HCD that talks to the sample hardware
* sample-deploy - for starting/deploying HCD's and Assembly's
